...
IF OBJECT_ID('tblDepartment') IS NOT NULL AND COL_LENGTH('tblDepartment', 'AliasName') IS NULL
    ALTER TABLE tblDepartment ADD AliasName NVARCHAR(50) NULL;
IF OBJECT_ID('tblDepartment') IS NOT NULL AND COL_LENGTH('tblDepartment', 'DepartmentManagerID') IS NULL
    ALTER TABLE tblDepartment ADD DepartmentManagerID INT NULL;
IF OBJECT_ID('tblDivision') IS NOT NULL AND COL_LENGTH('tblDivision', 'AliasName') IS NULL
    ALTER TABLE tblDivision ADD AliasName NVARCHAR(50) NULL;
IF OBJECT_ID('tblBloodGroup') IS NOT NULL AND COL_LENGTH('tblBloodGroup', 'AliasName') IS NULL
    ALTER TABLE tblBloodGroup ADD AliasName NVARCHAR(50) NULL;
IF OBJECT_ID('tblReligion') IS NOT NULL AND COL_LENGTH('tblReligion', 'AliasName') IS NULL
    ALTER TABLE tblReligion ADD AliasName NVARCHAR(50) NULL;
IF OBJECT_ID('tblNationality') IS NOT NULL AND COL_LENGTH('tblNationality', 'AliasName') IS NULL
    ALTER TABLE tblNationality ADD AliasName NVARCHAR(50) NULL;
IF OBJECT_ID('tblBenefitEntitlement') IS NOT NULL AND COL_LENGTH('tblBenefitEntitlement', 'AliasName') IS NULL
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblCurrency' AND type = 'U')
BEGIN
    ...
    INSERT INTO tblCurrency (CurrencyCode, CurrencyName, AliasName, IsActive) VALUES
        ('PKR', 'Pakistani Rupee', 'Rs', 1),
        ('USD', 'US Dollar', '$', 1),
        ('EUR', 'Euro', '€', 1),
        ('GBP', 'British Pound', '£', 1),
        ('AED', 'UAE Dirham', 'AED', 1),
        ('SAR', 'Saudi Riyal', 'SAR', 1);
END
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblBankGroup' AND type = 'U')
BEGIN
    CREATE TABLE tblBankGroup (
        BankGroupID      INT IDENTITY(1,1) PRIMARY KEY,
        BankGroupName    NVARCHAR(100) NOT NULL UNIQUE,
    ...
    INSERT INTO tblBankGroup (BankGroupName, AliasName, IsActive) VALUES
        ('Payroll', 'PR', 1),
        ('Operations', 'OPS', 1),
        ('Vendor Payments', 'VP', 1),
        ('General', 'GEN', 1);
END
GO
...
IF COL_LENGTH('tblEmployeeBank', 'BankCode') IS NULL
    ALTER TABLE tblEmployeeBank ADD BankCode NVARCHAR(50) NULL;
IF COL_LENGTH('tblEmployeeBank', 'LocationName') IS NULL
    ALTER TABLE tblEmployeeBank ADD LocationName NVARCHAR(150) NULL;
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblInvoice' AND type = 'U')
BEGIN
    CREATE TABLE tblInvoice (
        ...
        BuyerNTNCNIC              NVARCHAR(50)  NULL,
        BuyerProvince           NVARCHAR(100) NULL,
        BuyerAddress            NVARCHAR(500) NULL,
        BuyerRegistrationType   NVARCHAR(100) NULL,
        InvoiceRefNo            NVARCHAR(100) NULL,
        CustomerName            NVARCHAR(200) NULL,
        CustomerNTNCNIC           NVARCHAR(50)  NULL,
        CustomerID              INT           NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblInvoiceItem' AND type = 'U')
BEGIN
    CREATE TABLE tblInvoiceItem (
        ...
        SroItemSerialNo   NVARCHAR(100) NULL,
...
-- =============================================
-- Customer Setup Lookup Tables
-- =============================================
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblModeOfDelivery' AND type = 'U')
BEGIN
    CREATE TABLE tblModeOfDelivery (
        ModeOfDeliveryID   INT IDENTITY(1,1) PRIMARY KEY,
        ModeOfDeliveryName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName          NVARCHAR(50) NULL,
        IsActive           BIT NOT NULL DEFAULT 1,
        CreatedOn          DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn         DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblMethodOfPayment' AND type = 'U')
BEGIN
    CREATE TABLE tblMethodOfPayment (
        MethodOfPaymentID   INT IDENTITY(1,1) PRIMARY KEY,
        MethodOfPaymentName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName           NVARCHAR(50) NULL,
        IsActive            BIT NOT NULL DEFAULT 1,
        CreatedOn           DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn          DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblCustomerGroup' AND type = 'U')
BEGIN
    CREATE TABLE tblCustomerGroup (
        CustomerGroupID   INT IDENTITY(1,1) PRIMARY KEY,
        CustomerGroupName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName         NVARCHAR(50) NULL,
        IsActive          BIT NOT NULL DEFAULT 1,
        CreatedOn         DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn        DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblTermsOfPayment' AND type = 'U')
BEGIN
    CREATE TABLE tblTermsOfPayment (
        TermsOfPaymentID   INT IDENTITY(1,1) PRIMARY KEY,
        TermsOfPaymentName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName          NVARCHAR(50) NULL,
        IsActive           BIT NOT NULL DEFAULT 1,
        CreatedOn          DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn         DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblCustomerClass' AND type = 'U')
BEGIN
    CREATE TABLE tblCustomerClass (
        CustomerClassID   INT IDENTITY(1,1) PRIMARY KEY,
        CustomerClassName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName         NVARCHAR(50) NULL,
        IsActive          BIT NOT NULL DEFAULT 1,
        CreatedOn         DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn        DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblBillPreference' AND type = 'U')
BEGIN
    CREATE TABLE tblBillPreference (
        BillPreferenceID   INT IDENTITY(1,1) PRIMARY KEY,
        BillPreferenceName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName          NVARCHAR(50) NULL,
        IsActive           BIT NOT NULL DEFAULT 1,
        CreatedOn          DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn         DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblTaxGroup' AND type = 'U')
BEGIN
    CREATE TABLE tblTaxGroup (
        TaxGroupID       INT IDENTITY(1,1) PRIMARY KEY,
        TaxGroupName     NVARCHAR(100) NOT NULL UNIQUE,
        AliasName        NVARCHAR(50) NULL,
        IsActive         BIT NOT NULL DEFAULT 1,
        CreatedOn        DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn       DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblFBRStatus' AND type = 'U')
BEGIN
    CREATE TABLE tblFBRStatus (
        FBRStatusID      INT IDENTITY(1,1) PRIMARY KEY,
        FBRStatusName    NVARCHAR(100) NOT NULL UNIQUE,
        AliasName        NVARCHAR(50) NULL,
        IsActive         BIT NOT NULL DEFAULT 1,
        CreatedOn        DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn       DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblContactMaster' AND type = 'U')
BEGIN
    CREATE TABLE tblContactMaster (
        ContactID            INT IDENTITY(1,1) PRIMARY KEY,
        ContactCode          NVARCHAR(20) NOT NULL UNIQUE,
        CustomerID           INT NULL,
        ContactFor           NVARCHAR(200) NULL,
        ContactType          NVARCHAR(50) NOT NULL DEFAULT 'Customer',
        ContactStatus        NVARCHAR(20) NOT NULL DEFAULT 'Active',
        Name                 NVARCHAR(200) NOT NULL,
        SearchName           NVARCHAR(200) NULL,
        GenderID             INT NULL,
        MaritalStatus        NVARCHAR(20) NULL,
        ProfessionalTitle    NVARCHAR(150) NULL,
        Department           NVARCHAR(150) NULL,
        OfficeLocation       NVARCHAR(200) NULL,
        AvailableFrom        TIME NULL,
        AvailableTo          TIME NULL,
        ReportToManagerName  NVARCHAR(200) NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblContactGhaziResponsible' AND type = 'U')
BEGIN
    CREATE TABLE tblContactGhaziResponsible (
        ContactGhaziResponsibleID INT IDENTITY(1,1) PRIMARY KEY,
...
-- Product setup lookup tables
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblProductNature' AND type = 'U')
BEGIN
    CREATE TABLE tblProductNature (
        ProductNatureID   INT IDENTITY(1,1) PRIMARY KEY,
        ProductNatureName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName         NVARCHAR(50) NULL,
        IsActive          BIT NOT NULL DEFAULT 1,
        CreatedOn         DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn        DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblItemRegistered' AND type = 'U')
BEGIN
    CREATE TABLE tblItemRegistered (
        ItemRegisteredID   INT IDENTITY(1,1) PRIMARY KEY,
        ItemRegisteredName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName          NVARCHAR(50) NULL,
        IsActive           BIT NOT NULL DEFAULT 1,
        CreatedOn          DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn         DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblBrandCode' AND type = 'U')
BEGIN
    CREATE TABLE tblBrandCode (
        BrandCodeID      INT IDENTITY(1,1) PRIMARY KEY,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblBrandGroup' AND type = 'U')
BEGIN
    CREATE TABLE tblBrandGroup (
        BrandGroupID   INT IDENTITY(1,1) PRIMARY KEY,
        BrandGroupName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName      NVARCHAR(50) NULL,
        IsActive       BIT NOT NULL DEFAULT 1,
        CreatedOn      DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn     DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblProductGroup' AND type = 'U')
BEGIN
    CREATE TABLE tblProductGroup (
        ProductGroupID   INT IDENTITY(1,1) PRIMARY KEY,
        ProductGroupName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName        NVARCHAR(50) NULL,
        IsActive         BIT NOT NULL DEFAULT 1,
        CreatedOn        DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn       DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblProductSalesGroup' AND type = 'U')
BEGIN
    CREATE TABLE tblProductSalesGroup (
        ProductSalesGroupID   INT IDENTITY(1,1) PRIMARY KEY,
        ProductSalesGroupName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName             NVARCHAR(50) NULL,
        IsActive              BIT NOT NULL DEFAULT 1,
        CreatedOn             DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn            DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblItemGroup' AND type = 'U')
BEGIN
    CREATE TABLE tblItemGroup (
        ItemGroupID   INT IDENTITY(1,1) PRIMARY KEY,
        ItemGroupName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName     NVARCHAR(50) NULL,
        IsActive      BIT NOT NULL DEFAULT 1,
        CreatedOn     DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn    DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblSalesCategory' AND type = 'U')
BEGIN
    CREATE TABLE tblSalesCategory (
        SalesCategoryID   INT IDENTITY(1,1) PRIMARY KEY,
        SalesCategoryName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName         NVARCHAR(50) NULL,
        IsActive          BIT NOT NULL DEFAULT 1,
        CreatedOn         DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn        DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblProductDivision' AND type = 'U')
BEGIN
    CREATE TABLE tblProductDivision (
        ProductDivisionID   INT IDENTITY(1,1) PRIMARY KEY,
        ProductDivisionName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName           NVARCHAR(50) NULL,
        IsActive            BIT NOT NULL DEFAULT 1,
        CreatedOn           DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn          DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblProductTeam' AND type = 'U')
BEGIN
    CREATE TABLE tblProductTeam (
        ProductTeamID   INT IDENTITY(1,1) PRIMARY KEY,
        ProductTeamName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName       NVARCHAR(50) NULL,
        IsActive        BIT NOT NULL DEFAULT 1,
        CreatedOn       DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn      DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblHSCode' AND type = 'U')
BEGIN
    CREATE TABLE tblHSCode (
        HSCodeID           INT IDENTITY(1,1) PRIMARY KEY,
        HSCode             NVARCHAR(20) NOT NULL UNIQUE,
        HSCodeDescription  NVARCHAR(200) NOT NULL,
        IsActive           BIT NOT NULL DEFAULT 1,
        CreatedOn          DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn         DATETIME NULL,
        CreatedByUserID    INT NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblInventoryType' AND type = 'U')
BEGIN
    CREATE TABLE tblInventoryType (
        InventoryTypeID   INT IDENTITY(1,1) PRIMARY KEY,
        InventoryTypeName NVARCHAR(100) NOT NULL UNIQUE,
        AliasName         NVARCHAR(50) NULL,
        IsActive          BIT NOT NULL DEFAULT 1,
        CreatedOn         DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn        DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblUnitOfMeasure' AND type = 'U')
BEGIN
    CREATE TABLE tblUnitOfMeasure (
        UnitOfMeasureID   INT IDENTITY(1,1) PRIMARY KEY,
        UnitOfMeasureName NVARCHAR(50) NOT NULL UNIQUE,
        AliasName         NVARCHAR(100) NULL,
        IsActive          BIT NOT NULL DEFAULT 1,
        CreatedOn         DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn        DATETIME NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblProduct' AND type = 'U')
BEGIN
    CREATE TABLE tblProduct (
        ...
        ItemID                NVARCHAR(50) NULL,
        SUUnitOfMeasureID     INT NULL,
        PUUnitOfMeasureID     INT NULL,
        IUUnitOfMeasureID     INT NULL,
        ProductNatureID       INT NULL,
        ItemRegisteredID      INT NULL,
        BrandCodeID           INT NULL,
        BrandGroupID          INT NULL,
        ProductGroupID        INT NULL,
        ProductSalesGroupID   INT NULL,
        ItemGroupID           INT NULL,
        SalesCategoryID       INT NULL,
        ProductDivisionID     INT NULL,
        ProductTeamID         INT NULL,
        HSCodeID              INT NULL,
        CreatedOn             DATETIME NOT NULL DEFAULT GETDATE(),
        ModifiedOn            DATETIME NULL,
        CreatedByUserID       INT NULL,
...
INSERT INTO @AuditTables (TableName) VALUES
    ...
    ('tblBankMaster'),('tblBankGroup'),('tblCurrency'),('tblReligion'),('tblNationality'),('tblLanguage'),
    ...
    ('tblModeOfDelivery'),('tblMethodOfPayment'),('tblCustomerGroup'),('tblTermsOfPayment'),
    ('tblCustomerClass'),('tblBillPreference'),('tblTaxGroup'),('tblFBRStatus'),('tblCustomer'),('tblContactMaster'),('tblContactGhaziResponsible'),
    ('tblProductNature'),('tblItemRegistered'),('tblBrandCode'),('tblBrandGroup'),('tblProductGroup'),('tblProductSalesGroup'),
    ('tblItemGroup'),('tblSalesCategory'),('tblProductDivision'),('tblProductTeam'),('tblHSCode'),('tblInventoryType'),('tblUnitOfMeasure'),('tblProduct'),
    ('tblInvoice'),('tblInvoiceItem');
...
-- =============================================
-- Task Management (tblTask + tblTaskHistory)
-- Also applied on startup via Program.cs migrations.
-- =============================================
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblTask' AND type = 'U')
BEGIN
    CREATE TABLE tblTask (
        ...
        ReferenceType             NVARCHAR(30)  NOT NULL DEFAULT 'None',
        ReferenceEmployeeID       INT           NULL,
        ReferenceCustomerID       INT           NULL,
        ReferenceVendorID         INT           NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'tblTaskHistory' AND type = 'U')
BEGIN
