<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WorkArrangementSetup.aspx.cs" Inherits="HRMS.WorkArrangementSetupPage" %>
...
<div class="card mt-4"><div class="card-header"><h2><%= ItemLabel %> List</h2></div>
...
<tr><td><%= Server.HtmlEncode(item.Code) %></td><td><%= Server.HtmlEncode(item.Name) %></td><td><%= Server.HtmlEncode(item.AliasName) %></td><td><%= item.IsActive ? "Active" : "Inactive" %></td>
